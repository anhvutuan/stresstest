...
def GenReqHeader(method):
       ...
       if method == "get" or method == "head":
        ...
        header =  referer + useragent + deviceuid + app_id + authorization + accept + connection + "\r\n"
       elif method == "post":
        ...
        header = post_host + accept + refer + content + user_agent + deviceuid + app_id + authorization + length + "\n" + data + "\r\n\r\n"
       return header
...
def downloadsocks(choice):
       if choice == "4":
        ...
        try:
            ...
            pass    
        try:
            r = requests.get("https://raw.githubusercontent.com/yemixzy/proxy-list/main/proxies/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass    
        try:
            r = requests.get("https://raw.githubusercontent.com/Zaeem20/FREE_PROXIES_LIST/master/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/zevtyardt/proxy-list/main/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/mmpx12/proxy-list/master/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/MuRongPIG/Proxy-Master/main/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/NotUnko/autoproxies/main/socks4_2.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/NotUnko/autoproxies/main/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/ObcbO/getproxy/master/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/officialputuid/KangProxy/KangProxy/socks4/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/proxylist-to/proxy-list/main/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/prxchk/proxy-list/main/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            ...
            pass
        try:
            r = requests.get("https://fastly.jsdelivr.net/gh/jetkai/proxy-list@main/online-proxies/txt/proxies-socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            ...
            pass
        try:
            r = requests.get("https://www.freeproxychecker.com/result/socks4_proxies.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            ...
            pass
        try:
            r = requests.get("https://fastly.jsdelivr.net/gh/UserR3X/proxy-list@main/online/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass    
        try:
            r = requests.get("https://fastly.jsdelivr.net/gh/TheSpeedX/PROXY-List@master/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://fastly.jsdelivr.net/gh/roosterkid/openproxylist@main/SOCKS4_RAW.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://www.proxyscan.io/api/proxy?format=txt&type=socks4",timeout=5)
            f.write(r.content)
        except:
            pass            
        try:
            ...
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/HyperBeats/proxy-list/main/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/hanwayTech/free-proxy-list/main/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/ErcinDedeoglu/proxies/main/proxies/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/B4RC0DE-TM/proxy-list/main/SOCKS4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/ALIILAPRO/Proxy/main/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://proxyspace.pro/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass                        
        try:
            r = requests.get("https://proxysearcher.sourceforge.net/Proxy%20List.php?type=socks",timeout=5)
            f.write(r.content)
        except:
            pass

        try:
            r = requests.get("https://openproxylist.xyz/socks4.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://openproxy.space/list/socks4",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
       ...
       if choice == "5":
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://www.proxyscan.io/api/proxy?format=txt&type=socks5",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://fastly.jsdelivr.net/gh/roosterkid/openproxylist@main/SOCKS5_RAW.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://fastly.jsdelivr.net/gh/TheSpeedX/PROXY-List@master/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://fastly.jsdelivr.net/gh/UserR3X/proxy-list@main/online/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://fastly.jsdelivr.net/gh/hookzof/socks5_list@master/proxy.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://fastly.jsdelivr.net/gh/jetkai/proxy-list@main/online-proxies/txt/proxies-socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/zevtyardt/proxy-list/main/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/Zaeem20/FREE_PROXIES_LIST/master/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/yemixzy/proxy-list/main/proxies/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            ...
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/steamboatid/proxyout/main/proxy-socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/prxchk/proxy-list/main/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/HyperBeats/proxy-list/main/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            ...
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/hanwayTech/free-proxy-list/main/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/ErcinDedeoglu/proxies/main/proxies/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/caliphdev/Proxy-List/master/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/B4RC0DE-TM/proxy-list/main/SOCKS5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/ALIILAPRO/Proxy/main/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://openproxylist.xyz/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://openproxy.space/list/socks5",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://api.proxyscrape.com/v2/?request=getproxies&protocol=socks5",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/NotUnko/autoproxies/main/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/ObcbO/getproxy/master/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/officialputuid/KangProxy/KangProxy/socks5/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
            r = requests.get("https://raw.githubusercontent.com/proxylist-to/proxy-list/main/socks5.txt",timeout=5)
            f.write(r.content)
        except:
            pass
        try:
